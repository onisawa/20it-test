    ...
    const info = [
      {
        ...
        fixed: data.threeDOne.childImageSharp.fixed,
        reverse: true
      },
      {
        title: 'IT-Mentorship',
        ...
        fixed: data.threeDTwo.childImageSharp.fixed, 
      },
      {
        ...
        fixed: data.threeDThree.childImageSharp.fixed,
        reverse: true
      },
      {
        ...
        fixed: data.threeDFour.childImageSharp.fixed, 
      },
      {
        ...
        fixed: data.threeDFive.childImageSharp.fixed,
        reverse: true
      },
    ]
    return (
